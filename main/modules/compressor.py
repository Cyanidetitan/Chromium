...
async def gg():
  cmd = 'ffmpeg -hide_banner -loglevel quiet -progress "progressaa.txt" -i "video.mkv" -vf subtitles=video.mkv -preset fast -c:v libx264 -crf 25 -map 0:v -c:a aac -map 0:a -c:s copy -map 0:s? "out.mkv" -y'  
